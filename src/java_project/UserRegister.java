...
public class UserRegister extends JFrame {
    ...
    public UserRegister() {
        ...
        lblNewUserRegister.setFont(new Font("Arial", Font.PLAIN, 42));

        lblNewUserRegister.setBounds(291, 58, 360, 50);
        ...
        lblName.setBounds(58, 152, 146, 49);
        ...
        lblNewLabel.setBounds(58, 243, 146, 42);
        ...
        lblEmailAddress.setBounds(58, 324, 146, 46);
        ...
        email.setBounds(214, 318, 228, 50);
        ...
        lblUsername.setBounds(542, 159, 145, 42);
        ...
        lblPassword.setBounds(542, 245, 139, 40);
        ...
        lblMobileNumber.setBounds(542, 329, 155, 41);
        ...
        lblsector.setFont(new Font("Arial", Font.BOLD, 16));

        lblsector.setForeground(new Color(0, 0, 0));

        lblsector.setBounds(541, 400, 121, 41);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String Sector = lblsector.getText();
        ...
        btnNewButton.setBounds(393, 488, 184, 62);

        contentPane.add(btnNewButton);
        
        JComboBox sector = new JComboBox();
        sector.setBounds(707, 401, 228, 40);
        contentPane.add(sector);
        
        sector.addItem("administration");
        sector.addItem("Teacher");
        sector.addItem("Student");
